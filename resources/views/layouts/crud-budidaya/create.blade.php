    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h1 class="font-bold pl-2">Tambah Data Budidaya</h1>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow shadow-sky-200 p-4">
            <form action="{{ route('budidaya.store') }}" method="POST">
                ...
                <div class="px-3">
                    <button type="reset" class="bg-slate-400 text-white py-2 px-4 rounded-full hover:font-bold hover:bg-grey-400 cursor-pointer">Batal</button>
